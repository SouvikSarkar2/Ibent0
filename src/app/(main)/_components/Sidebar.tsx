...
const Sidebar = () => {
  ...
  return (
    <div className="bg-slate-200 dark:bg-primary rounded-3xl w-[15%] dark:text-text flex flex-col items-center gap-3 pt-10">
      {pathname !== "/dashboard" && (
        <div className="flex py-4 px-3 w-[90%]">
          <Link
            href={"/dashboard"}
            className="bg-slate-400 dark:bg-[#2C293D] p-1 rounded-full"
